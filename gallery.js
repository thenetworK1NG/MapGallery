document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateAllLikeButtons() {
        document.querySelectorAll('.gallery-item').forEach(item => {
            ...
            if (likeButton && imagePath) {
                ...
                console.log(`User ${userId} liked ${imagePath}: ${userLiked}`); // Debug log
            }
        });
    }
    ...
    function handleLike(imagePath, likeButton, likeCount) {
        ...
        if (userLiked) {
            ...
            console.log(`User ${userId} unliked image: ${imagePath}, Firebase key: ${firebaseKey}, New total likes: ${newLikes}`);
        } else {
            ...
            console.log(`User ${userId} liked image: ${imagePath}, Firebase key: ${firebaseKey}, New total likes: ${newLikes}`);
        }
    }
